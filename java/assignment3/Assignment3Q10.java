...
public class Assignment3Q10 {
    ...
    public static void main(String[] args) {
    	MovieDetails m1 = new MovieDetails("The Conjuring","Patrick Wilson","Lili Taylor","Horror");
    	MovieDetails m2 = new MovieDetails("SpiderMan","Tobey Marguire","Kristen","Fantasy");
    	MovieDetails m3 = new MovieDetails("Alpha","Kodi","Natassia","Adventure");
    	MovieDetails m4 = new MovieDetails("Iron-man","Robert","Evadki tesulu","Sci-Fi");
    	MovieDetails m5 = new MovieDetails("Jumanji","Dwayne","Karen","Adventure");
    	MovieDetails m6 = new MovieDetails("Do Little","Robert","Marion Cotillard","Comedy");
